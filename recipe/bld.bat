...
copy ..\builds\libcurl-vc%VS_MAJOR:"=%-%ARCH_STRING%-release-static-zlib-dll-ssh2-dll-ipv6-sspi-schannel-obj-lib\libcurl_a.lib %LIBRARY_PREFIX%\lib\libcurl_a.lib
