...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/curl-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/curl-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add curl libcurl libcurl-static
# for installing globally
pixi global install curl libcurl libcurl-static
```
...
It is possible to list all of the versions of `curl` available on your platform:
...
```
pixi search curl --channel conda-forge
```
